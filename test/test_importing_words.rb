...
require_relative '../lib/importer'
 ...
 class TestImportingWords < JstudyTest
  ...
  def test_03_extra_categories_arent_created
   import_data
   assert_equal 2, Category.all.count
  end

  def test_04_categories_are_created_as_needed
   Category.find_or_create("Vocabulary")
   Category.find_or_create("Selfstudy")
   import_data
